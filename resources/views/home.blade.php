                ...
                <div class="app-card-body px-4 w-100">
                    ...
                    <div class="card mb-4">
                        <div class="card-body" style="background-color: {{ Auth::user()->main_id == $item->char_id ? '#f1eaea' : ''}}">
                            <h5 class="card-title" style="color:blue">{{ $item->getName() }} <small style="font-size: 14px; color: black">{{ Auth::user()->main_id == $item->char_id ? "(Nhân vật chính)" : ""}}</small></h5>
                            ...
                            <p class="card-text char"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                              ...
                              <p class="card-text char"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
                            ...
                            <br>
                            <a href="/doi-mon-phai/{{$item->char_id}}" class="btn btn-sm btn-danger mb-2" style="color:white">Đổi môn phái</a>

                            @if(Auth::user()->main_id != $item->char_id)
                            <a href="/set_main_char/{{$item->char_id}}" class="btn btn-sm btn-success mb-2" style="color:white">Đặt làm nhân vật chính</a>
                            @endif
                        </div>
                    </div>
                    @endforeach
