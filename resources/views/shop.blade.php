...
<div class="container-xl">
        ...
        <div class="col-12 col-md-12 col-xl-6 col-xxl-6">
            <div class="app-card app-card-doc shadow-sm h-100">
                <div class="app-card-body p-3 has-card-actions">
                    ...
                    <h2 class="app-doc-title truncate mb-0" style="font-size:18px !important"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="green" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                ...
                <form class="row p-4" action="" method="POST">
                    @csrf
                    <div class="col-6">
                        <input type="number" min="1" stack="{{ $item->stack }}" price="{{ $item->price }}" max="{{ $item->stack }}"
                            id="quantity-x-{{$item->id}}" required name="quantity" value="1"
                    ...
                    <div class="col-6">
                        <button type="button" id="btn-max-{{$item->id}}" class="btn btn-mua btn-max btn-secondary">Tối đa</button>
